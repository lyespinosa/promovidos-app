      ...
      <View className="flex-1 justify-center bg-gray-300/[0.4] blur-2xl">
        <BlurView intensity={5}>
          <View className="items-center h-[80vh] my-[20vh]  bg-white mx-5 border-2 border-[#E8E8E8] rounded-3xl overflow-hidden shadow-md shadow-[#E8E8E8]">
            <View className="flex-row border-b border-[#E8E8E8] bg-red-500 w-full p-2">
            <Text className="flex-1 text-center pl-6 text-white font-extrabold text-[20px]">Promovidos</Text>
              <FontAwesome name="close" size={24} color="white" onPress={() => setIsModalOpen(!setIsModalOpen)}/>
            </View>
          </View>
        </BlurView>
      </View>
